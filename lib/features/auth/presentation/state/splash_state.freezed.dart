...
mixin _$SplashState {
 ...
 bool get isChecking; SplashEffect? get effect;
...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SplashState&&(identical(other.isChecking, _this.isChecking) || other.isChecking == _this.isChecking)&&(identical(other.effect, _this.effect) || other.effect == _this.effect));
}
...
int get hashCode {
  final _this = this as SplashState;
  return Object.hash(runtimeType,_this.isChecking,_this.effect);
}

@override
String toString() {
  final _this = this as SplashState;
  return 'SplashState(isChecking: ${_this.isChecking}, effect: ${_this.effect})';
}
...
@useResult
$Res call({
 bool isChecking, SplashEffect? effect
});
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isChecking = null,Object? effect = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isChecking,  SplashEffect? effect)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.isChecking,_that.effect);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isChecking,  SplashEffect? effect)  $default,) {final _that = this;
switch (_that) {
case _SplashState():
return $default(_that.isChecking,_that.effect);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isChecking,  SplashEffect? effect)?  $default,) {final _that = this;
switch (_that) {
case _SplashState() when $default != null:
return $default(_that.isChecking,_that.effect);case _:
  return null;
...
class _SplashState implements SplashState {
  const _SplashState({this.isChecking = true, this.effect});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _SplashState&&(identical(other.isChecking, isChecking) || other.isChecking == isChecking)&&(identical(other.effect, effect) || other.effect == effect));
}


@override
int get hashCode {
    return Object.hash(runtimeType,isChecking,effect);
}

@override
String toString() {
    return 'SplashState(isChecking: $isChecking, effect: $effect)';
}
...
/// Create a copy of SplashState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isChecking = null,Object? effect = freezed,}) {

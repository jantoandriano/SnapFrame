...
mixin _$ReviewState {
 ...
 Frame get frame; List<XFile> get captures; Uint8List? get previewJpeg; bool get isComposing; AppException? get error; ReviewEffect? get effect;
...
int get hashCode {
  final _this = this as ReviewState;
  return Object.hash(runtimeType,_this.frame,const DeepCollectionEquality().hash(_this.captures),const DeepCollectionEquality().hash(_this.previewJpeg),_this.isComposing,_this.error,_this.effect);
}

@override
String toString() {
  final _this = this as ReviewState;
  return 'ReviewState(frame: ${_this.frame}, captures: ${_this.captures}, previewJpeg: ${_this.previewJpeg}, isComposing: ${_this.isComposing}, error: ${_this.error}, effect: ${_this.effect})';
}
...
@useResult
$Res call({
 Frame frame, List<XFile> captures, Uint8List? previewJpeg, bool isComposing, AppException? error, ReviewEffect? effect
});
...
/// Create a copy of ReviewState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? frame = null,Object? captures = null,Object? previewJpeg = freezed,Object? isComposing = null,Object? error = freezed,Object? effect = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Frame frame,  List<XFile> captures,  Uint8List? previewJpeg,  bool isComposing,  AppException? error,  ReviewEffect? effect)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewState() when $default != null:
return $default(_that.frame,_that.captures,_that.previewJpeg,_that.isComposing,_that.error,_that.effect);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Frame frame,  List<XFile> captures,  Uint8List? previewJpeg,  bool isComposing,  AppException? error,  ReviewEffect? effect)  $default,) {final _that = this;
switch (_that) {
case _ReviewState():
return $default(_that.frame,_that.captures,_that.previewJpeg,_that.isComposing,_that.error,_that.effect);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Frame frame,  List<XFile> captures,  Uint8List? previewJpeg,  bool isComposing,  AppException? error,  ReviewEffect? effect)?  $default,) {final _that = this;
switch (_that) {
case _ReviewState() when $default != null:
return $default(_that.frame,_that.captures,_that.previewJpeg,_that.isComposing,_that.error,_that.effect);case _:
  return null;
...
class _ReviewState implements ReviewState {
  const _ReviewState({required this.frame, required  List<XFile> captures, this.previewJpeg, this.isComposing = false, this.error, this.effect}): _captures = captures;
...
@override
int get hashCode {
    return Object.hash(runtimeType,frame,const DeepCollectionEquality().hash(_captures),const DeepCollectionEquality().hash(previewJpeg),isComposing,error,effect);
}

@override
String toString() {
    return 'ReviewState(frame: $frame, captures: $captures, previewJpeg: $previewJpeg, isComposing: $isComposing, error: $error, effect: $effect)';
}
...
/// Create a copy of ReviewState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? frame = null,Object? captures = null,Object? previewJpeg = freezed,Object? isComposing = null,Object? error = freezed,Object? effect = freezed,}) {

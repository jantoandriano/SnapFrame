...
/// Locked (pro-tier) frames get a dark scrim, a lock icon, and a "PRO ✦"
/// sticker; tapping still fires [onTap] — the caller decides whether that
/// opens the frame or the paywall.
class FrameCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      button: true,
      label: isLocked ? '$title, pro frame, locked' : title,
